			...
			{!isMobile ? (
				<div className={styles.container}>
					...
					<div className={styles.innerContainer}>
						<div className={styles.textContainer}>
							<div className={styles.text1}>시행: ㈜계룡건설 엘리프ㅣ 시공: ㈜대우건설, 중흥토건㈜</div>
							...
							<div className={styles.text2}>COPYRIGHTⓒ 계룡건설 엘리프 모델하우스 ALL RIGHTS RESERVED.</div>
						</div>
				...
				<div className={styles.container}>
					...
					<div className={styles.innerContainer}>
						...
						<div className={styles.textContainer}>
							<div className={styles.text1}>시행: ㈜계룡건설 엘리프 ㅣ 시공: ㈜대우건설, 중흥토건㈜</div>
							<div className={styles.text1}>※본 사이트의 내용 및 이미지는 소비자의 이해를 돕기 위한 것으로 실제와 다를 수 있습니다.</div>
							<div className={styles.text1}> 대표자명: 박지훈 / eyeful31@naver.com </div>
							<div className={styles.text2}>COPYRIGHTⓒ 계룡건설 엘리프 모델하우스 ALL RIGHTS RESERVED.</div>
						</div>
